...
public class TLStatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> AQUA_TREADER = register("aqua_treader", new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0x5c89dc).addAttributeModifier(EntityAttributes.GENERIC_WATER_MOVEMENT_EFFICIENCY, Identifier.of(TipsyLib.MOD_ID, "effect.aqua_treader"), 1.0, EntityAttributeModifier.Operation.ADD_MULTIPLIED_BASE));
    ...
    public static final RegistryEntry<StatusEffect> SLICING = register("slicing", new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, -4377188).addAttributeModifier(EntityAttributes.PLAYER_ENTITY_INTERACTION_RANGE, Identifier.of(TipsyLib.MOD_ID, "effect.swiping"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE));
