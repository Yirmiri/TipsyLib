...
//TODO: 1.21 effects
    ...
    public static final RegistryEntry<StatusEffect> CAFFEINATED = register("caffeinated", new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0x492f25).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 0.03, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_ARMOR, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 2.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 2.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_JUMP_STRENGTH, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_LUCK, Identifier.of(TipsyLib.MOD_ID, "effect.caffeinated"), 1.0, EntityAttributeModifier.Operation.ADD_VALUE));
    public static final RegistryEntry<StatusEffect> BRIMSTONE_VISION = register("brimstone_vision", new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0xf57d4a));
    ...
    public static final RegistryEntry<StatusEffect> BLEEDING = register("bleeding", new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x410909));
    ...
    public static final RegistryEntry<StatusEffect> CAFFEINE_CRASH = register("caffeine_crash", new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x313d99).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -1.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -0.03, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_ARMOR, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -2.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_MAX_HEALTH, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -2.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_JUMP_STRENGTH, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -1.0, EntityAttributeModifier.Operation.ADD_VALUE).addAttributeModifier(EntityAttributes.GENERIC_LUCK, Identifier.of(TipsyLib.MOD_ID, "effect.caffeine_crash"), -1.0, EntityAttributeModifier.Operation.ADD_VALUE));
