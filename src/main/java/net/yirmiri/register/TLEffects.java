...
public class TLEffects {
    ...
    public static final StatusEffect PERCEPTION = new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0x336d37);
    public static final StatusEffect TRUE_INVISIBILITY = new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0xffffff);
    public static final StatusEffect ENIGMA = new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0x020202);
    ...
    public static final StatusEffect HYPER_ELASTICITY = new NoSpecialEffect(StatusEffectCategory.BENEFICIAL, 0x9ad8fa);
    //NEUTRAL
    public static final StatusEffect DROWSY = new NoSpecialEffect(StatusEffectCategory.NEUTRAL, 0x84d0c7);
    public static final StatusEffect GRAVITY_RESISTANCE = new NoSpecialEffect(StatusEffectCategory.NEUTRAL, 0xc451a4);
    //HARMFUL
    ...
    public static final StatusEffect FAST_FALLING = new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x969dab);
    ...
    public static void registerStatusEffect() {
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier(TipsyLib.MODID, "lesser_weakness"), LESSER_WEAKNESS);
        ...
        Registry.register(Registries.STATUS_EFFECT, new Identifier(TipsyLib.MODID, "lesser_strength"), LESSER_STRENGTH);
