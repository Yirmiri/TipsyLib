...
public class TLMobEffects {
    ...
    public static final StatusEffect HEARTBREAK = new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x3b0402);
    public static final StatusEffect BLEEDING = new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x7a0f0f);
    ...
    public static final StatusEffect CREATIVE_SHOCK = new NoSpecialEffect(StatusEffectCategory.HARMFUL, 0x8b33b1); //TODO: FINISH
