...
public class CapeLayerMixin {
    @Mutable @Final private ResourceLocation texture;
    //Capes for devs and contributors of any Azurune mods
    private static final List<String> AZURUNE = List.of("1cedf927-5c8f-4650-95e9-808fc8f94d00", "bd35c402-fa9c-4d00-afe6-b4ed9ebe90c4"); //Yirmiri
...
//    public void tipsylib_render(CallbackInfoReturnable<ResourceLocation> cir) {
//        Player player = Minecraft.getInstance().player;
//        String stringUUID = player.getStringUUID();
//        if (AZURUNE.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/azurune.png"); }
//        if (REDEYEVAIN.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/redeyevain.png"); }
//        if (BEETROOT.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/beetroot.png"); }
//        if (DEMONHEART.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/demonheart.png"); }
//        if (ACCURSED.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/accursed.png"); }
//        if (HEX.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/hex.png"); }
//        if (PUMPKIN_QUEEN.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/pumpkin_queen.png"); }
//        if (SAD_CLOUD.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/sad_cloud.png"); }
//        if (WRATHFUL.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/wrathful.png"); }
//        if (BUG.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/bug.png"); }
//        if (AXOLOTL.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/axolotl.png"); }
//        if (LIGHTNING.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/lightning.png"); }
//        if (REBELLIOUS.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/rebellious.png"); }
//        if (DICE.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/dice.png"); }
//        if (FUDGE_SUNDAE.contains(stringUUID)) { texture = TipsyLib.id("textures/capes/fudge_sundae.png"); }
//    }
}